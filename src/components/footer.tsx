        ...
        <footer className="bg-white text-black border-t border-border py-16">
            <div className="container mx-auto px-4 md:px-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                             <div className="flex flex-col gap-2.5">
                                {offerings.map((item, index) => (
                                    <Link key={index} href={item.href}  className={cn("group relative flex items-center gap-4 p-4 overflow-hidden bg-gray-100/50 text-black", item.highlighted && 'bg-gradient-to-r from-gradient-start to-gradient-end text-white', "before:content-[''] before:absolute before:inset-0 before:w-full before:h-full before:bg-gradient-to-r before:from-gradient-start before:to-gradient-end before:scale-x-0 before:origin-left before:transition-transform before:duration-300 before:ease-in-out hover:before:scale-x-100 hover:text-white")}>
                                        <span className={cn("absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b", item.highlighted ? "from-white/50 to-white/10" : "from-gradient-start to-gradient-end")}></span>
                            ...
                            <div className="flex flex-col gap-2.5">
                                {contacts.map((item, index) => (
                                    <Link href={item.href} key={index} className={"group relative flex items-center gap-4 p-4 overflow-hidden bg-gray-100/50 before:content-[''] before:absolute before:inset-0 before:w-full before:h-full before:bg-gradient-to-r before:from-gradient-start before:to-gradient-end before:scale-x-0 before:origin-left before:transition-transform before:duration-300 before:ease-in-out hover:before:scale-x-100 hover:text-white"}>
                                        <span className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-gradient-start to-gradient-end"></span>
                                        <div className="relative z-10 flex items-center gap-4">
                            ...
                            <div className="relative flex flex-1 border border-border">
                                ...
                                <div className="flex flex-col w-16">
                                    {socialLinks.map((link, index) => (
                                        <Link key={index} href={link.href} tabIndex={-1} className="flex-1 flex items-center justify-center p-4 bg-gradient-to-r from-gradient-start to-gradient-end hover:opacity-80 transition-opacity border-b border-white last:border-b-0">
                ...
                <div className="grid gap-12 md:grid-cols-3">
                     <div className="md:col-span-2">
                        <h3 className="font-headline text-2xl font-bold tracking-wider text-black mb-6">STAY UPDATED WITH US</h3>
                    ...
                    <div className="md:col-span-1">
                        ...
                        <p className="text-gray-600"><span className="text-black font-medium">Visit Us:</span> PLot 31, Rural Industrial Estate, Main Saharanpur Road, Loni, Ghaziabad, UP</p>
                        <p className="text-gray-600 mt-2"><span className="text-black font-medium">Timings:</span> 9:30 AM - 6:30 PM</p>
                        <p className="text-gray-600">7 Days Open</p>
                    </div>
                </div>
